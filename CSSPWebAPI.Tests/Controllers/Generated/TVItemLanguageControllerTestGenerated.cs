        ...
        public void TVItemLanguage_Controller_GetTVItemLanguageList_Test()
        {
            foreach (LanguageEnum LanguageRequest in AllowableLanguages)
            {
                foreach (int ContactID in new List<int>() { AdminContactID })  //, TestEmailValidatedContactID, TestEmailNotValidatedContactID })
                {
                    ...
                    Assert.AreEqual(tvItemLanguageFirst.TVItemLanguageID, ret.Content[0].TVItemLanguageID);
                    ...
                    if (count > 0)
                    {
                        ...
                        Assert.AreEqual(tvItemLanguageList[0].TVItemLanguageID, ret.Content[0].TVItemLanguageID);
                        Assert.AreEqual((count > query.Take ? query.Take : count), ret.Content.Count);
                       ...
                       if (count > 1)
                       {
                           ...
                           Assert.AreEqual(tvItemLanguageList[1].TVItemLanguageID, ret2.Content[0].TVItemLanguageID);
        ...
        public void TVItemLanguage_Controller_GetTVItemLanguageWithID_Test()
        {
            foreach (LanguageEnum LanguageRequest in AllowableLanguages)
            {
                foreach (int ContactID in new List<int>() { AdminContactID })  //, TestEmailValidatedContactID, TestEmailNotValidatedContactID })
                {
                    ...
                    Assert.AreEqual(tvItemLanguageFirst.TVItemLanguageID, tvItemLanguageRet.TVItemLanguageID);
        ...
        public void TVItemLanguage_Controller_Put_Test()
        {
            foreach (LanguageEnum LanguageRequest in AllowableLanguages)
            {
                foreach (int ContactID in new List<int>() { AdminContactID })  //, TestEmailValidatedContactID, TestEmailNotValidatedContactID })
                {
                    ...
                    OkNegotiatedContentResult<TVItemLanguage> tvItemLanguageRet2 = jsonRet2 as OkNegotiatedContentResult<TVItemLanguage>;
                    Assert.IsNotNull(tvItemLanguageRet2);
